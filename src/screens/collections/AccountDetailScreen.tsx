...
const makeStyles = (theme: Theme) =>
  StyleSheet.create({
    title: { fontSize: 21, fontWeight: '900', color: theme.colors.text },
    sub: { marginTop: 3, fontSize: 13, color: theme.colors.muted },
    kv: { marginTop: 5, fontSize: 13, color: theme.colors.text, lineHeight: 18 },
    projected: { marginTop: 9, fontSize: 13, color: theme.colors.primary, fontWeight: '700' },
    savedRow: {
      marginTop: 10,
      padding: 11,
    ...
    savedText: { flex: 1, fontSize: 13, fontWeight: '800', color: theme.colors.text },
    editChip: {
      paddingVertical: 6,
