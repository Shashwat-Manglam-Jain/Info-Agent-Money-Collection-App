...
import { getAccountCount, getCollectionTotalsForDate, getPendingExportCounts } from '../../db/repo';
import { toISODate } from '../../utils/dates';
import { formatINR } from '../../utils/money';
import { theme } from '../../theme';

export function ReportsScreen() {
  const { db, agent, society } = useApp();
  ...
  useFocusEffect(
    useCallback(() => {
      (async () => {
        ...
        const [totals, pending, accountCount] = await Promise.all([
